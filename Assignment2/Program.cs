...
namespace Assignment2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            title = "Ben Caplan"; table.Add(title, new Concert(title, "location3", 80, new DateTime(2021, 6, 18, 20, 20, 0)));
            title = "AC/DC"; table.Add(title, new Concert(title, "location4", 70, new DateTime(2021, 8, 19, 21, 25, 0)));
